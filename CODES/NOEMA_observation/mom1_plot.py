...
# %%
## Load data ##
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/NOEMA/w20cf/w20cf_origin/w20cf007/"
name = "F14167+4247"
file = name + "_CO32.fits"
file_mom0 = name + "_CO32_mom0.fits"
file_mom1 = name + "_CO32_mom1.fits"
file_mom2 = name + "_CO32_mom2.fits"
...
mom1_level = np.linspace(-200, 200, 4)
fig = plt.figure(figsize=(8,10))
ax = plt.subplot(projection=wcs[0])

im = ax.imshow(mom1 - 116, vmin=-80, vmax=80, cmap='jet', origin='lower')
...
cb.set_label(name+' velocity [$\mathrm{km\,s^{-1}}$]')
#ax.contour(mom1 - 460, mom1_level, colors=['k'])
...
#plt.savefig("/home/qyfei/Desktop/Results/NOEMA_detection/origin/"+name+"_mom1.pdf", bbox_inches="tight", dpi=300)
