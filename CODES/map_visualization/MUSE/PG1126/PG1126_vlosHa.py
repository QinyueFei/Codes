...
im = ax.imshow(vlosHa + 14.09, vmin=level[0]+5, vmax=level[-1]-5, cmap='coolwarm', origin='lower')
...
ax.contour(vlosHa + 14.09, level, colors=['k'])
...
# plt.savefig("/home/qyfei/Desktop/Results/map_visualization/MUSE/PG1126/PG1126_vlosHa.pdf", bbox_inches="tight", dpi=300)

# %%


hdu[1].header['CTYPE1'] = 'RA---SIN'
hdu[1].header['CRVAL1'] = 1.723198083333E+02
hdu[1].header['CDELT1'] = -0.2*u.arcsec.to('deg')
hdu[1].header['CRPIX1'] = 158
hdu[1].header['CUNIT1'] = 'deg     '

hdu[1].header['CTYPE2'] = 'DEC---SIN'
hdu[1].header['CRVAL2'] = -4.401880555562E+00
hdu[1].header['CDELT2'] = 0.2*u.arcsec.to('deg')
hdu[1].header['CRPIX2'] = 161
...
fits.writeto("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG1126/Barolo_fit/MUSE_Ha/PG1126_VlosHa.fits", vlosHa, hdu[1].header, overwrite=True)
