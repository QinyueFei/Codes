...
# %%
## laod the data
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG0923/Barolo_fit/MUSE_Ha/output/NONE"
...
ax.text(1.5, np.nanmean(Xcenter[N])+1.2, "%.2f"%np.nanmean(Xcenter[N]), color='r', fontsize=40)
ax.text(1.5, np.nanmean(Ycenter[N])-1.2, "%.2f"%np.nanmean(Ycenter[N]), color='b', ha='left', va='top', fontsize=40)
plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/pos_prof_Xpos.pdf", bbox_inches="tight", dpi=300)
...
plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/pa_prof.pdf", bbox_inches="tight", dpi=300)
...
ax.text(1.5, np.nanmean(Vsys[N]), "%.2f"%np.nanmean(Vsys[N]), color='k')
plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/vsys_prof.pdf", bbox_inches="tight", dpi=300)

# %%
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG0923/Barolo_fit/MUSE_Ha/output/NONE"
mod_file = "/NONE_2d_mod.fits"
dat_file = "/../../PG0923_VlosHa.fits"
...
pix_size = 0.20
phase_cen = [159, 157.5]
pos_cen = [156.29, 156.78]

rad = np.array([1.5, 4.0, 6.2, 10])*u.kpc*Planck15.arcsec_per_kpc_proper(0.029)
...
# ax.scatter(phase_cen[0], phase_cen[1], marker='+', s=200, color='r', zorder=3)
ax.scatter(pos_cen[0], pos_cen[1], marker='x', s=250, color='k', zorder=3)
...
ax.set_xticks([])
ax.set_yticks([])
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/vlos_present.pdf", bbox_inches="tight", dpi=300)
...
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/res_map.pdf", bbox_inches="tight", dpi=300)
...
# %%
radius = iso_rad(315, 318, (pos_cen[0], pos_cen[1]), 0.2, 260.06+90, 40)
ring_bound = np.arange(0, 19.75, 0.5)
...
# np.savetxt("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG0923/Barolo_fit/MUSE_Ha/output/NONE/vel_prof.txt", np.array([Radius, Vrot, ring_res]).T)

# %%
norm = 1*u.arcsec/Planck15.arcsec_per_kpc_proper(0.029)
plt.figure(figsize=(8, 8))
ax = plt.subplot(111)
...
norm = 1*u.arcsec/Planck15.arcsec_per_kpc_proper(0.029)
## Load 2D fit of Ha
Radius, Vrot, ring_res = np.genfromtxt("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG0923/Barolo_fit/MUSE_Ha/output/NONE/vel_prof.txt", skip_header=0, unpack=True)
...
ax0.fill_between(x=(4.0, 6.2), y1=0, y2=1000, color='yellow', alpha=0.2, zorder=3)

ax0.set_xlim(1e-2, 11.5)
ax0.set_ylim(0, 365)
ax0.grid()
ax0.fill_between([0, 2*(RAD_kpc[1]-RAD_kpc[0])], [-500], [500], color='k', hatch='/', alpha=0.1)
plt.legend()
ax0.text(0.5, 350, "PG\,0923+129", ha='left', va='top', fontsize=40)
...
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG0923/MUSE/rot_cur_tot.pdf", bbox_inches="tight", dpi=300)
