...
# plt.savefig("/home/qyfei/Desktop/Results/map_visualization/MUSE/PG0923/PG0923_vlosHa.pdf", bbox_inches="tight", dpi=300)

# %%


hdu[1].header['CTYPE1'] = 'RA---SIN'
hdu[1].header['CRVAL1'] = 1.916469071000E+02
hdu[1].header['CDELT1'] = -0.2*u.arcsec.to('deg')
hdu[1].header['CRPIX1'] = 159
hdu[1].header['CUNIT1'] = 'deg     '

hdu[1].header['CTYPE2'] = 'DEC---SIN'
hdu[1].header['CRVAL2'] = 2.369116900000E+00
...
fits.writeto("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG0923/Barolo_fit/MUSE_Ha/PG0923_VlosHa.fits", vlosHa, hdu[1].header, overwrite=True)
