...
# %%
## laod the data
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG2130/Barolo_fit/MUSE_Ha/output/NONE"
...
ax.vlines(5, 0, 180, color='k', ls='--')
ax.vlines(9, 0, 180, color='k', ls='--')
ax.vlines(15, 0, 180, color='k', ls='--')

ax.set_ylim(120, 180)
ax.set_xlim(0, 20)
N = np.where((Radius>1.5) & (Radius<5))
...
plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/pos_prof.pdf", bbox_inches="tight", dpi=300)
...
ax.vlines(5, 0, 1000, color='k', ls='--')
ax.vlines(9, 0, 1000, color='k', ls='--')
ax.vlines(15, 0, 1000, color='k', ls='--')
...
# ax.scatter(Radius[N], PA[N], marker = 'o', edgecolors='k', color='b', s=50, label='PA')

plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/pa_prof.pdf", bbox_inches="tight", dpi=300)
...
ax.vlines(1.5, -2000, 1000, color='k', ls='--')
ax.vlines(5, -1000, 1000, color='k', ls='--')
ax.vlines(9, -1000, 1000, color='k', ls='--')
ax.vlines(15, -1000, 1000, color='k', ls='--')
ax.set_ylim(-35, 35)
ax.set_xlim(0, 20)
N = np.where((Radius>1.5) & (Radius<5))
...
plt.legend()
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/vsys_prof.pdf", bbox_inches="tight", dpi=300)

# %%
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG2130/Barolo_fit/MUSE_Ha/output/NONE"
mod_file = "/NONE_2d_mod.fits"
dat_file = "/../../PG2130_VlosHa.fits"
...
# pos_cen = [159, 157.5]
phase_cen = [162, 158]
pos_cen = [160.89, 160.96]

rad = np.array([1.5, 5, 9, 13])*u.kpc*Planck15.arcsec_per_kpc_proper(0.048)
...
ax.contour(radius, levels = rad.value, linewidths=3.5, colors=['k', 'b', 'b','k'], linestyles=['-','--','--','-'])
...
ax.set_xticks([])
ax.set_yticks([])
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/vlos_mod.pdf", bbox_inches="tight", dpi=300)
...
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/res_map.pdf", bbox_inches="tight", dpi=300)
...
# %%
radius = iso_rad(323, 316, (pos_cen[0], pos_cen[1]), 0.20, 242.56+90, 56)
ring_bound = np.arange(0, 15.75, 0.5)
...
# np.savetxt("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG2130/Barolo_fit/MUSE_Ha/output/NONE/vel_prof.txt", np.array([Radius, Vrot, ring_res]).T)

# %%
norm = 1*u.arcsec/Planck15.arcsec_per_kpc_proper(0.048)
plt.figure(figsize=(8, 8))
ax = plt.subplot(111)
...
ax.vlines(5 * norm.value, 0, 1000, color='k', ls='--')
ax.vlines(9 * norm.value, 0, 1000, color='k', ls='--')
ax.vlines(14 * norm.value, 0, 1000, color='k', ls='--')
...
# %%
## Load 2D fit of Ha
Radius, Vrot, ring_res = np.genfromtxt("/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG2130/Barolo_fit/MUSE_Ha/output/NONE/vel_prof.txt", skip_header=0, unpack=True)

## Load 3D fit of CO(2-1)
object = "PG2130"
name = "PG2130+099"
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/"+object
folder = "/Barolo_fit/output/"+name+"_pre"
...
ax0.vlines(1.5, 0, 1000, color='k', ls='-.', lw=0.7)
ax0.vlines(14, 0, 1000, color='k', ls='-.', lw=0.7)
ax0.fill_between(x=(5., 9.), y1=0, y2=1000, color='yellow', alpha=0.2, zorder=1)

ax0.set_xlim(1e-2, 15.5)
ax0.set_ylim(0, 425)
ax0.grid()
ax0.fill_between([0, 2*(RAD_kpc[1]-RAD_kpc[0])], [-500], [500], color='k', hatch='/', alpha=0.3, zorder=3)
plt.legend()
ax0.text(0.5, 415, "PG\,2130+099", ha='left', va='top', fontsize=40)
...
# plt.savefig("/home/qyfei/Desktop/Results/Barolo/PG_quasars/PG2130/MUSE/rot_cur_tot.pdf", bbox_inches="tight", dpi=300)
