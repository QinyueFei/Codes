...
def log_prior(theta):
    ...
    # if not (9.02<log_Mb<11.84 and 9.24<log_Mtot<12.24 and log_Mb<log_Mtot and -2.25<log_fb<-1.3 and (log_con_theory-0.1)<log_con<(log_con_theory+0.1) and 2.84<alpha_CO<5.84): 
...
output_dir = "/home/qyfei/Desktop/Results/Dynamics/results/PG0923/rotation_velocity/CO_based/stellar_mass_constrained_one_sigma_boundary/"
