...
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG1126/Barolo_fit/output/PG1126-041"
file = "/ringlog2.txt"
...
convert = Planck15.arcsec_per_kpc_proper(0.060).value
log_Mb = 10.43
re = 1.00 / convert
n = 4.0
...
def log_prior(theta):
    ...
    if not (8<log_Mb<15 and 8<log_Mtot<15 and log_Mb<log_Mtot and -2.25<log_fb<-1.3 and (log_con_theory-0.1)<log_con<(log_con_theory+0.1) and 0<alpha_CO<20): 
...
output_dir = "/home/qyfei/Desktop/Results/Dynamics/results/PG1126/rotation_velocity/CO_based/alpha_CO_constrained_one_sigma_gauss/"
