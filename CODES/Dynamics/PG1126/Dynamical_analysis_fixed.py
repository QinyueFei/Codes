...
initial = np.array([re, n, rd, log_Mdh, con, a]) + 0.1 * np.random.randn(6)#Mb, re, n, Md, rd, 
soln = minimize(nll, initial, args=(r_fit_tot, vrot_tot, evrot_tot, vasy_tot), method="Nelder-Mead")#, disp_tot, edisp_tot

print("Fitting result:")
re_ml, n_ml, rd_ml, log_Mdh_ml, con_ml, a_ml = soln.x #
...
output_dir = "/home/qyfei/Desktop/Results/Dynamics/results/PG0923/rotation_velocity/CO_based/stellar_mass_fixed/"
...
ax = plt.subplot(111)
v_b = V_b(r_test, 10.43, parameters[0], parameters[1]) #parameters[0], parameters[1], parameters[2]
log_Md = np.log10(10**10.74 - 10**10.43)
v_d = V_d(r_test, log_Md, parameters[2]) #parameters[3], parameters[4]
