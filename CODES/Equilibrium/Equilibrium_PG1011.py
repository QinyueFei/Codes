...
def surface_density_mom0(mom0_, hdu_):
    ...
    z = 0.058          #The redshift of the galaxy
...
# %%
path = "/media/qyfei/f6e0af82-2ae6-44a3-a033-f66b47f50cf4/ALMA/Type1AGN/PG_quasars/PG1011/data"
...
file_mom0 = "/PG1011-040_CO21_final_image_mom0.fits"
hdu = fits.open(path+file_mom0)[0]
mom0 = fits.open(path+file_mom0)[0].data[0][0]
file_mom2 = "/PG1011-040_CO21_final_image_mom2.fits"
mom2 = fits.open(path+file_mom2)[0].data[0][0]

# %%
rms = 0.049
pix_size = abs(hdu.header['CDELT1']*u.deg.to('arcsec'))
radius = iso_rad(180, 180, np.array([90.70, 88.80]), pix_size, -10-90, 40)
...
ax.scatter(88.80, 90.70, s=200, marker='x', color='b', label='KC')
...
# plt.savefig("/home/qyfei/Desktop/Results/Physical_values/Equilibrium/PG1011_show.pdf", bbox_inches="tight", dpi=300)
...
# plt.savefig("/home/qyfei/Desktop/Results/Physical_values/Equilibrium/PG1011_equilibrium.pdf", bbox_inches="tight", dpi=300)
